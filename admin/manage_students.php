    ...
    <div class="management-layout">
        ...
        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
            ...
            <section class="admin-card">
                ...
                <p style="color: var(--text-muted); font-size: 0.9em; margin-bottom: 20px;">Upload an Excel/CSV file with 3 columns:<br><b>Student ID, Full Name, Programme</b>.</p>
                <form action="../actions/save_student.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="action" value="import_csv">
                    <div class="file-upload-wrapper">
                        <input type="file" name="csv_file" id="csv_file" accept=".csv" class="file-upload-input" required>
                        <div class="file-upload-btn"><span id="file-upload-text">Click to choose a .csv file</span></div>
                    </div>
                    <button type="submit" class="btn-success" style="background-color: var(--accent);">Import File</button>
                </form>
            </section>
        </div>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td style='display:flex;gap:6px;flex-wrap:wrap;'>
                                    ...
                                    <form action='../actions/save_student.php' method='POST' style='display:inline;' class='delete-form' data-confirm-msg='Delete {$name}? All their internship data will be lost forever.'>
